...
func fixtureResponse(fixture Fixture) Response {
	...
	return Response{
		...
		Behavior: BehaviorInfo{
			...
			QUICVersions: splitFixtureHeaderList(header.Get("X-HFinger-Fixture-QUIC-Versions")),
			Signals:      splitFixtureHeaderList(header.Get("X-HFinger-Fixture-Behavior-Signals")),
		},
	}
}
